                        ...
                        <DialogContent>
                            <Wrapper style={{ marginTop: -10 }}>
                                <Typography gutterBottom>
                                    <Box>
                                   { this.props.activeRow.responses.length === 0 && (  <h3 style={{ textAlign: "center" , fontStyle:"Montserrat"}}>  No students registered yet  </h3>)};
                                        {
                                            
                                            this.props.activeRow.responses.map(response => {
                                                return (
                                                    <div style={{ paddingBottom: 15, fontStyle:"Montserrat" }}>
                                                        <h4 style={{ textAlign: "center" , fontStyle:"Montserrat" }}>  Student {response.studentDetails.fullName}  </h4>
                                                        ...
                                                        <Email
                                                         ...
                                                         <Email
                                                            style={{ textAlign: "center" }}
                                                            type="text"
                                                            value={"Phone: " + response.studentDetails.phoneNumber}
                                                            readonly="readonly"
                                                            ></Email>
                                                            <Email
                                                            style={{ textAlign: "center" }}
                                                            type="text"
                                                            value={"University: " + response.studentDetails.university}
                                                            readonly="readonly"
                                                            ></Email>
